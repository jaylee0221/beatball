...
window.addEventListener('error',function(e){
  ...
  // "Script error." with no file/line = a cross-origin script (extension, in-app browser) — not ours, don't wipe the app
  if(!e.filename&&!e.lineno&&!e.error){window.__log('ignored foreign error: '+e.message);return;}
