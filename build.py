...
<style>{css}</style></head><body><div id="app"><div style="padding:40px 20px;font:500 14px/1.5 -apple-system,Archivo,sans-serif;color:#8A9099">Loading Fantasyball…</div></div><pre id="bootlog" hidden></pre><script>{trap}</script>
